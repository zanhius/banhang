                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($sanPhams as $sanPham)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.edit_san_pham', $sanPham) }}" class="btn btn-success" style="display: inline-block; margin-right: 10px;">Sửa</a>
                                        <form action="{{ route('admin.delete_san_pham', $sanPham) }}" method="POST" style="display: inline-block;">
                                            @csrf
                                            @method('DELETE')
