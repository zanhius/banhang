...
@section('title-page', "Sửa voucher")
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
                ...
                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group row">
                                    <label for="number_use" class="col-md-4 col-form-label text-md-right">Số Lượt</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="number_use"
                                               value="{{ $vouchers->number_use }}" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select id="status" class="form-control @error('status') is-invalid @enderror"
                                            ...
                                            <option value="0" {{ $vouchers->status == 0 ? 'selected' : '' }}>Hoạt Động
                                            </option>
                                            <option value="1" {{ $vouchers->status == 1 ? 'selected' : '' }}>Không Hoạt Động
                                            </option>
                                        </select>
                                        @error('status')
                                        <span class="invalid-feedback" role="alert">
